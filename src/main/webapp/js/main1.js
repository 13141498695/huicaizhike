    ...
    $(window).scroll(function(){
        ...
        if($bodyWidth>768){
            ...
            if( $headetTop > $bodyHeight){
                ...
                $("#header").find(".nav a").stop().css({"height":"36px","line-height":"36px","font-size":"16px"},400);        
                ...
                $("#header").stop().css({"background":"rgba(0,0,0,0.3)","border-bottom":"0"}).css({"padding":"12px 0"},400).find("h1 a").stop().css("backgroundImage","url(/images/logo.png)").css({"width":"205px","height":"57px"},400);
                $("#header").find(".nav a").stop().css({"height":"57px","line-height":"57px","font-size":"18px"},400);
        ...
        if( $scrollTop >370){
        	if($conTop>0)
        	{
            	$("#zixun .left").css({"position":"fixed", "top":"105px"});
            }
        	else{
        		$("#zixun .left").css({"position":"relative","top":"0"});
        	}
        }
        else{
            $("#zixun .left").css({"position":"relative","top":"0"});
